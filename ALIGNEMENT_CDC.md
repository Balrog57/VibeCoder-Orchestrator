...
Statut : `PARTIEL`
Concret :
- intention presente via QMD
- pas de couche explicite configurable exposee dans l'application (backend vectoriel et modele embedding selectionnables)
Zone :
- [utils/memory.js](./utils/memory.js)
- [setup.js](./setup.js)
...
Statut : `GAP`
Concret :
- pas de suite de test standard en place
Zone :
...
2. Ajouter la couche vector store + embedding local configurable.
3. Finaliser l'i18n GUI (supprimer les hardcodes restants).
4. Mettre en place une vraie suite de tests.
